...
plot.mesh.3D<-function(x,...){
 ...
 R_eval_local.FEM = function(FEM, locations, element_index)
 {
  ...
  #' @param ... Arguments representing graphical options
  #' @description Plot of a \code{FEM.time} object, generated by \code{FEM.time} or returned by \code{smooth.FEM.time}
  #' @usage plot.fixed.point(x,x1,x2,x3=NULL,timeInterval = x$mesh_time, N=100, NameLocation=NA,type="l", col='red', samePlot = FALSE, main = NA, ...)
